...
@section('body')
    <section class="main text-center">
        <div class="text-center bg-accent-first p-3" id="upper-card">
            ...
            <hr class="my-4">
            <p>TaskManager поможет вам организовать свои задачи, установить приоритеты и добиться большей продуктивности.
            </p>
            ...
            <div class="row">
                <div class="offset-1 col-5 pr-3">
                    <div class="bg-accent-second home-card-wrap p-1">
                        ...
                        <p>TaskManager предлагает интуитивно понятный интерфейс, который делает управление задачами простым
                            и
                            эффективным.</p>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <p>TaskManager - это инструмент, который поможет вам управлять вашим временем и задачами более
                        эффективно.
                    ...
                    <ul class="list-unstyled text-left">
                        ...
                        <li class="mb-3">
                            <i class="fas fa-check text-primary mr-2"></i>
                            <span>Удобство использования: Интуитивно понятный интерфейс делает работу с TaskManager простой
                                и
                                приятной.</span>
                        </li>
                        <li class="mb-3">
                            <i class="fas fa-check text-primary mr-2"></i>
                            <span>Доступность: TaskManager доступен на всех устройствах, поэтому вы можете использовать его
                                в
